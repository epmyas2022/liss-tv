  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white relative px-3 sm:px-0">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://assets.nflxext.com/ffe/siteui/vlv3/a00fdfd7-4916-4f12-b5ff-c05b9d7b4d07/web/SV-es-20260824-TRIFECTA-perspective_61a35102-b7d7-41ef-ab0c-e381f4eb2343_large.jpg)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(145deg, rgba(20,20,20,0.4) 0%, rgba(5,5,5,0.6) 100%)",
          backdropFilter: "blur(32px) saturate(200%)",
          WebkitBackdropFilter: "blur(32px) saturate(200%)",
          border: "1px solid rgba(255, 255, 255, 0.12)",
          boxShadow:
            "0 30px 60px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.15), inset 0 0 20px rgba(234,28,37,0.1)",
        }}
      >
        <h1 className="text-4xl sm:text-3xl font-bold font-poppins text-center mb-2 sm:mb-2">
          Liss <span className="text-[#EA1C25]">TV</span>
        </h1>
        <p className="text-white/60 text-center mb-8 sm:mb-6 text-lg sm:text-base">
        ...
        <FocusContextProvider condition={true}>
          ...
          >
            <div>
              <label className="block text-base sm:text-sm font-medium mb-2 sm:mb-1.5 text-white/80">
                Email
              </label>
            ...
            <FocusElementProvider
              className="rounded-xl mt-4 sm:mt-4"
              onEnterPress={() => formRef.current?.requestSubmit()}
            >
              <button
                type="submit"
                disabled={loading}
                className="w-full  flex justify-center items-center gap-2 bg-[#EA1C25] hover:bg-[#c9171f] disabled:opacity-70 disabled:hover:bg-[#EA1C25] text-white font-bold py-4 sm:py-3 rounded-xl transition-colors text-lg sm:text-base"
              >
                {loading ? (
