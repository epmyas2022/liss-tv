        ...
        <div className="px-4 pt-3 pb-4 flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2">
            <div
              ...
              style={{ background: "rgba(234,28,37,0.35)" }}
            />
            <div
          ...
          <div className="flex flex-col gap-2 mt-1">
            ...
            />
            <div
              className="h-4 rounded w-4/6 animate-pulse"
              style={{ background: "rgba(255,255,255,0.06)" }}
            />
          </div>
        </div>
      ...
      <div className="hidden md:block relative">
        ...
        <div className="relative z-10 flex flex-row items-start gap-8 px-6 pt-36 pb-16 max-w-5xl mx-auto w-full">
          ...
          <div className="flex flex-col gap-4 pb-2 w-full max-w-md">
            <div
              className="h-10 rounded-lg w-3/4 animate-pulse"
      ...
      <section className="max-w-5xl mx-auto px-6 pb-20 w-full">
        ...
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="flex items-center gap-4 py-3 px-3">
            <div
              className="shrink-0 w-6 h-5 rounded animate-pulse"
